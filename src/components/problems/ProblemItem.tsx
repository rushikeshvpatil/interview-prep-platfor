  ...
  return (
    <>
      {/* ==========================================
          DESKTOP TABLE ROW
          ========================================== */}
      <tr className="hidden md:table-row border-b border-border/70 hover:bg-muted/40 transition-colors group">
        {/* Status */}
      ...
      {/* ==========================================
          MOBILE CARD VIEW
          ========================================== */}
      <div className="md:hidden rounded-xl border border-border bg-card p-4 shadow-xs space-y-3">
